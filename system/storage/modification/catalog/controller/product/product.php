...
$data['product'] = $product_info['quantity'];
			...
			$data['marketshop_cloud_zoom'] = $this->config->get('marketshop_cloud_zoom');
			$data['marketshop_cloud_zoom_gallery'] = $this->config->get('marketshop_cloud_zoom_gallery');
			$data['marketshop_cloud_zoom_gallery_text'] = $this->config->get('marketshop_cloud_zoom_gallery_text');
			$data['marketshop_cloud_zoom_inner'] = $this->config->get('marketshop_cloud_zoom_inner');
			$data['marketshop_share_plugin'] = $this->config->get('marketshop_share_plugin');
			$data['marketshop_share_plugin_style'] = $this->config->get('marketshop_share_plugin_style');
			$data['marketshop_percentage_discount_badge'] = $this->config->get('marketshop_percentage_discount_badge');
			$data['marketshop_related_slider_product_per_row'] = $this->config->get('marketshop_related_slider_product_per_row');
...
if ($result) {
		...
		$this->document->addScript('catalog/view/javascript/jquery/owl-carousel/owl.carousel.min.js');
          ...
          'saving' => $result['price'] == 0 ? 100 : round((($result['price'] - $result['special'])/$result['price'])*100, 0)
			...
			$data['hd_ct23'] = $this->load->controller('common/hd_ct23');
			$data['hd_ct13'] = $this->load->controller('common/hd_ct13');
