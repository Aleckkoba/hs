...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		$this->load->model('tool/image');
			...
			$data['marketshop_refine_categories'] = $this->config->get('marketshop_refine_categories');
			$data['marketshop_refine_categories_images'] = $this->config->get('marketshop_refine_categories_images');
			$data['marketshop_percentage_discount_badge'] = $this->config->get('marketshop_percentage_discount_badge');
			$data['marketshop_category_product_per_row'] = $this->config->get('marketshop_category_product_per_row');
...
if(isset($result)){
    $image = $this->model_tool_image->resize($result['image'], $this->config->get($this->config->get('config_theme') . '_image_category_width'), $this->config->get($this->config->get('config_theme') . '_image_category_height'));
				...
				$data['categories'][] = array(
					...
					'href' => $this->url->link($route, $path . '_' . $result['category_id'] . $url), 'thumb' => $image
				);
			}
