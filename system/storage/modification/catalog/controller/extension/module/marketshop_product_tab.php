<?php
class ControllerExtensionModuleMarketshopProductTab extends Controller {
	public function index($setting) {
		static $module = 0;
		$this->load->language('extension/module/marketshop_product_tab');
		...
		$data['products'] = array();
			...
			$data['marketshop_product_tab_slider_product_per_row'] = $this->config->get('marketshop_product_tab_slider_product_per_row');
		...
		return $this->load->view('extension/module/marketshop_product_tab', $data);
