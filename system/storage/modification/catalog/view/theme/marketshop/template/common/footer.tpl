...
if((isset($marketshop_address[$lang]) && $marketshop_address[$lang] != '') || (isset($marketshop_contact[$lang]) && $marketshop_contact[$lang] != '') || (isset($marketshop_mobile[$lang]) && $marketshop_mobile[$lang] != '') || (isset($marketshop_email[$lang]) && $marketshop_email[$lang] != '')) { ?>
        <div class="contact col-lg-4 col-md-4 col-sm-12 col-xs-12">
          ...
          <ul>
            ...
            <li class="address"><i class="fa fa-map-marker"></i><a href="https://maps.google.com/maps?q=50.474794%2C+30.507712&hl=ru-ru&t=m&z=15" target="_blank"><?php echo $marketshop_address[$lang]; ?></a></li>
            <?php } ?>
            <?php } ?>
            ...
            <li class="email"><i class="fa fa-envelope"></i><a href="mailto:<?php echo $marketshop_email[$lang]; ?>"><?php echo $marketshop_email[$lang]; ?></a>
              <?php } ?>
              <?php } ?>
          </ul>
          <?php } ?>
