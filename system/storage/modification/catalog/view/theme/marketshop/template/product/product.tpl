    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div itemscope itemtype="http://schema.org/Product">
        ...
        <?php } ?>
          ...
          <?php if ($thumb || $images) { ?>
          <?php if($marketshop_cloud_zoom == 1) { ?>
          <div class="<?php echo $class; ?>">
            ...
            <?php } ?>
            <?php if($marketshop_cloud_zoom_gallery == 1) {
    $marketshop_cloud_zoom_gallery_text = $marketshop_cloud_zoom_gallery_text;
    if(isset($marketshop_cloud_zoom_gallery_text[$lang]) && $marketshop_cloud_zoom_gallery_text[$lang]!= '') { ?>
            ...
            <?php } ?>
            <?php if($marketshop_cloud_zoom_inner == 1) { ?>
...
$("#zoom_01").bind("click", function(e) {
  ...
  return false;
        ...
        <?php } ?>
            ...
            <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-514863386b357649"></script>
            <?php } ?>
            <?php if($marketshop_share_plugin_style == 3) { ?>
	...
	$(document).ready(function() {
		...
		itemsCustom : [[320, 1],[600, 2],[768, 3],[992, <?php echo $marketshop_related_slider_product_per_row; ?>],[1199, <?php echo $marketshop_related_slider_product_per_row; ?>]],											   
		lazyLoad : true,
		navigation : true,
...
<?php if($marketshop_cloud_zoom == 2) { ?>
$(document).ready(function() {
