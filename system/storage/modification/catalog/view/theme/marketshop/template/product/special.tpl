...
<?php if($marketshop_special_product_per_row == 'pr3') { ?>
  	<?php if ($column_left && $column_right) { ?>
...
if (localStorage.getItem('display') == 'list') {
    ...
    <?php } ?>
  <?php } elseif ($marketshop_special_product_per_row == 'pr4') {?>
	<script type="text/javascript">
$(document).ready(function(){
$(document).on('click', '#grid-view', function(e){
...
if (localStorage.getItem('display') == 'list') {
  ...
  <?php } elseif ($marketshop_special_product_per_row == 'pr5') {?>
	<script type="text/javascript">
$(document).ready(function(){
...
if (localStorage.getItem('display') == 'list') {
  ...
  <?php } elseif ($marketshop_special_product_per_row == 'pr6') {?>
    <script type="text/javascript">
$(document).ready(function(){
