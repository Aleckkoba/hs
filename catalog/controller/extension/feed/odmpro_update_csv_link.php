...
class ControllerExtensionFeedOdmproUpdateCSVLink extends Controller {
        ...
        public function getAnyYMLResult($odmpro_tamplate_data) {
            ...
            if($odmpro_tamplate_data['file_url']){
                ...
                $yml_file_name = $this->ocext_model_tool_csv_ocext_dmpro->getFileNameByURL($odmpro_tamplate_data['file_url']);
            ...
            if(is_string($yml_file_name) && $yml_file_name && strstr($yml_file_name,'.xml') && isset($this->setting_version_settings['functional']['yml_to_dsv']) && $this->setting_version_settings['functional']['yml_to_dsv']){
