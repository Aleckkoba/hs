...
class ModelToolCSVOcextDMPRO extends Model {
                    ...
                    foreach ($write_data_row as $column => $write_data_column_value) {
                        ...
                        if($write_data_column_value['value']!==''){
                            ...
                            if($related_data_column==1){
                                ...
                                $csv_row_new[$column] = implode('_____', $csv_row_values);
    ...
    public function getFileByURL($url,$httpcode=FALSE,$new_file_upload=FALSE) {
    ...
    public function getFileNameByURL($url,$httpcode=FALSE,$supplier_feed_source='') {
        ...
        foreach ($import_steps as $type_data => $step) {
            ...
            foreach ($import_data['data'] as  $csv_row_num_part => $csv_row_whis_data) {
                ...
                foreach ($csv_row_whis_data as $csv_position => $csv_value) {
                    ...
                    if(!isset($column_settings[$field]['self_column']) && isset($column_settings[$field]) && $csv_value==='' && $column_settings[$field]['additinal_settings']['column_request']==1){
                ...
                if($skip){
                    ...
                    if($self_column){
                        ...
                        foreach ($self_column as $self_column_field => $self_column_setting) {
                            ...
                            if(!isset($csv_data[ $self_column_field ])){
                                
                                unset($column_settings[$self_column_field]);
                                
                            }elseif($csv_data[ $self_column_field ]==='' && $column_settings[$self_column_field]['additinal_settings']['column_request']==1){
 ...
 */
    ...
    public function getAnyYMLResult($odmpro_tamplate_data) {
        ...
        if($odmpro_tamplate_data['file_url']){
            ...
            $yml_file_name = $this->getFileNameByURL($odmpro_tamplate_data['file_url'],FALSE,$supplier_feed_source);
    ...
    public function getLanguages($data = array()) {
        ...
        public function getPhpResult($csv_row,$php,$num_row=0,$result_xpath='',$entity_id=null) {
            ...
            foreach ($csv_row_result as $field => $value) {
                ...
                }elseif(isset(${$field}) && is_array($value) && $value['value'] && $value['value']!==${$field}){
