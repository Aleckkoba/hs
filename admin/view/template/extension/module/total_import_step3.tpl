                ...
                <div id="tab_adjust">
                    <div class="tab-pane active" id="tab_adjust" style="overflow: auto;">
                        ...
                        <div class="form-group">
                            <button type="button" id="nextRow" value="1" class="btn btn-primary" intercom-tracked="clicked-nextrow-step3">View Next Row</button>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered table-hover" id="addOperation" style="overflow: auto;">
                        ...
                        <tr id="adjustment_row_<?php echo $adjust_count; ?>">
                            <td class="text-left">
                                <p><?php echo $operations[$adjust[$row][0]]['name']; ?></p>
                                <?php if (!empty($operations[$adjust[$row][0]]['helptext'])) { ?>
                                    <span class="help-block"><?php echo $operations[$adjust[$row][0]]['helptext']; ?></span>
                                <?php } ?>
                        ...
                        <td class="left">
                            ...
                            <a class="button btn btn-primary" id="addOperation" onclick="addOperation();" intercom-tracked="added-operation"><?php echo $button_add_operation; ?></a>
                        </td>
                        </tfoot>
                    </table>
                    </div>
...
<script type="text/javascript">
    ...
    function addOperation(){
        ...
        if (operations[selected_op]) {
            ...
            html += '<td class="center"><p>'+ops['name']+'</p>';
            if (typeof ops['helptext'] !== 'undefined' && ops['helptext'] != '') {
                html += '<span class="help-block">' + ops['helptext'] + '</span>';
            }
    ...
    function buildSampleRow() {
        $.ajax({
            url: 'index.php?route=extension/module/total_import/getNextRow&user_token=<?php echo $token; ?>',
            type: 'post',
