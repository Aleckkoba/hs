...
<div class="form-group">
    <button type="button" id="nextRow" value="1" class="btn btn-primary" intercom-tracked="clicked-nextrow-step4">View Next Row</button>
</div>
<!-- Simple Update -->
            ...
            <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <?php foreach ($stores as $store) { ?>
                            <div class="input-group">
                                ...
                                <select name="field_names[<?php echo $input_name?>][<?php echo $store['store_id']; ?>]">
                                    <option value=''><?php echo $entry_none; ?></option>
                                        <?php foreach ($fields as $field) { ?>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                        <?php echo $pretty_name; ?>
                    <?php if ($pretty_name == 'Image') { ?>
                        <a href="https://hostjars.zendesk.com/hc/en-us/articles/203573769-Why-aren-t-my-images-working-"><i class="fa fa-question-circle"></i></a>
                    <?php } ?>
                    </label>
                    <div class="col-sm-10">
...
<script type="text/javascript"><!--
    ...
    $(document).ready(function() {
        ...
        if ($('#simple option:selected').val() == '0') {
            $('#full').show();
