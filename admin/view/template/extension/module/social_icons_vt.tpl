    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-social_icons_vt" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-google"><?php echo $text_google_vt; ?></label>
            <div class="col-sm-10">
                <input type="text" name="google_vt" value="<?=$google_vt ?>" placeholder="<?=$google_vt ?>" id="input-google" class="form-control" />
            </div>
          </div>  
          <div class="form-group">
      ...
      <p><small>&copy; <a style="text-align: center" href="http://vt-studio.com" target="_blank">VT Studio</a></small></p>
  </div>
</div>
<?php echo $footer; ?>