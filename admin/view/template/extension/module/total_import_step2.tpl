    ...
    <div id="tab_global">
        <div class="tab-pane active" id="tab_global">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <span class="help-block"><?php echo $help_remote_image; ?> <a href="https://hostjars.zendesk.com/hc/en-us/articles/203573769-Why-aren-t-my-images-working-"><i class="fa fa-question-circle"></i></a></span>
                </div>
            </div>
            ...
            <div class="form-group" id="image_subfolder" <?php if (!isset($remote_images) || $remote_images == 0) echo "style='display:none'"; ?>>
                ...
                <div class="col-sm-10">
                    ...
                    <span class="help-block"><?php echo $help_image_subfolder; ?></span>
                </div>
            </div>
        ...
        <!-- ########################################################### -->
            ...
            <div class="form-group">
               ...
               <!-- SEO Keyword -->
            <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_seo_keyword_category; ?></label>
                <div class="col-sm-10">
                    <select name="seo_keyword" class="form-control">
                        <option value="blank" ><?php echo $entry_seo_keyword_blank; ?></option>
                        <option value="categoryName" <?php if (isset($seo_keyword) && ($seo_keyword === 'categoryName')) echo 'selected="true"'; ?>><?php echo $entry_seo_keyword_category_name; ?></option>
                    </select>
                </div>
            </div>
